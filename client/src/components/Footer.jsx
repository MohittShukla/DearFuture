      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          <a
            ...
            className="p-2 rounded-full border border-ink/10 text-ink-secondary hover:text-hope hover:border-hope transition-all duration-300"
            aria-label="GitHub"
          >
            <svg
              className="w-5 h-5"
          ...
          <a
            href="https://www.linkedin.com/in/mohittshukla/"
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-full border border-ink/10 text-ink-secondary hover:text-hope hover:border-hope transition-all duration-300"
            aria-label="LinkedIn"
